...
const Weather = () => {
    ...
    useEffect( () => {
        ...
        const success = position => {
            ...
            axios.get(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=443f68899bdb3e99f4ef1c77d22ec6e7`)
                .then(response => {
    ...
    return (
        <div className='card__weather'>
            ...
            <div className='card__weather-climate'>
                <div className='card__weather-img'>
                    ...
                    <div className='card__weather-deg'>
                        <div className='card__weather-img-temp'>
                            <img src="./src/sun.ico" alt="" />
                        </div>
                        
                        <p>{celcius.toFixed(2)} {isCelcius ? '°C' : '°F'}</p>
                    </div>

                    <div className='card__weather-stade'>
                        <p>
                            Humidity:
            ...
            <button onClick={changesDeg} className='card__weather-button'>Degrees °F/°C</button>
        </div>
    );
};
